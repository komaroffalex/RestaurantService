...
public class DataGateway {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/rservicedb?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&useSSL=false&allowPublicKeyRetrieval=true";
    private static final String USER = "root";
    private static final String PASSWORD = "256007wow";
