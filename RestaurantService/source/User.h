#ifndef RESTAURANTSERVICE_USER_H
#define RESTAURANTSERVICE_USER_H
...
public:
    ...
    User(int id, std::string username, std::string password, std::string firstName, std::string lastName, std::string eMail, std::string messenger, std::string phoneNumber)
        : mId(id), mUsername(username), mPassword(password), mFirstName(firstName), mLastName(lastName), mEMail(eMail), mMessenger(messenger), mPhoneNumber(phoneNumber) 
    {};
...
#endif //RESTAURANTSERVICE_USER_H
